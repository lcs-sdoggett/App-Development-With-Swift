 ...
 */
print("The change in value won't work because the let in the first statment makes friends a constant, which can't be changed unlike a variable which can be changed.")
